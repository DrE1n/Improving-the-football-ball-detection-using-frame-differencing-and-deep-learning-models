...
def generate_midpoint_video(
    ...
    while True:
        ...
        if not ok or frame3 is None: # break when video end reached
            break
        frame_idx += 1
...
if __name__ == "__main__":
    generate_midpoint_video(
        ...
        out_path          = r"D:\final_videos\diff_mAP60%.mp4",
        model_path        = r"D:\dataset_new_runs\detect\frame_difference_run_mAP60%\weights\best.pt",
